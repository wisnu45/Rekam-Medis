                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="no_pasien" value="<?php echo $no_pasien ?>" class="form-control" readonly>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="tempat_lahir" value="<?php echo set_value('tempat_lahir') ?>" class="form-control">
