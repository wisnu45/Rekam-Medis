<div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Perubahan Data Pegawai</h6>
            </div>
            <div class="card-body">
              <form method="post">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                      <div class="btn-group d-flex" role="group" aria-label="Basic example">
                        ...
                        <a href="javascript:;" onclick="window.location.href='<?php echo base_url('data/pegawai'); ?>'" class="form-control btn btn-warning">Batal</a>
                        <a href="javascript:;" onclick="return confirm('Yakin ingin menghapus?') ? window.location.href='<?php echo base_url('hapus/pegawai/').$data['id']; ?>' : ''" class="form-control btn btn-danger">Hapus</a>
                      </div>
                    </div>
                  </div>
                </div>
